...
void usage(char* progName){
    ...
    cout << "  --run <command>                  immediately run 'command' after datapacks and functions are loaded" << endl;
...
int main(int argc, char* argv[]){
    ...
    for(int i = 1; i < argc; i++){
        ...
        if(arg == "--print-bytecode"){
            ...
            if (i + 1 < argc){
                ...
                cout << "--run expects an argument" << endl;
                usage(argv[0]);
                return 1;
            }
        }
            ...
            cout << ".zip based datapacks are not yet implemented. Sorry :(" << endl;
            return 1;
        }
        else {
            cout << "folder based datapacks are not yet implemented. Sorry :(" << endl;
            return 1;
        }
    }
    ...
    if(runCommand.has_value()){
        mainRuntime.processCommand(runCommand.value());
    }
